...
Depending on your exact use case, you should probably play around with the directions
given in the prompt. However, we recommend that you always specify that the results
